<template>
<div>
  <a target="_blank" :href="user.html_url"><img :src="user.avatar_url" width="128" height="128" alt="avatar"></a>
  <p>
    ...
    <span v-if="user.blog">URL: <a target="_blank" :href="user.blog">{{ user.blog }}</a></span>
  </p>
</div>
</template>
